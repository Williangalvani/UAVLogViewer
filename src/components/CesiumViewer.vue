    ...
    methods: {
        ...
        async fetchAvailableImages () {
            try {
                ...
                const response = await fetch(
                    `https://mapper.galvanicloop.com/images/bounds/?min_lat=${minLat}&min_lon=${minLon}&max_lat=${maxLat}&max_lon=${maxLon}`,
                    {
                        headers: {
                            accept: 'application/json'
                        }
        ...
        async uploadFile (file) {
            ...
            try {
                ...
                const response = await fetch('https://mapper.galvanicloop.com/images/upload', {
                    method: 'POST',
                    body: formData,
                    credentials: 'include'
                })
